...
class Application(tk.Frame):
    ...
    def ventana_consulta(self):
        ...
        self.consulta.geometry("800x90+50+20")
        ...
        self.boton_consultar.grid(row=2,column=0,columnspan=2)
    ...
    def resultado_consulta(self):
        if(len(self.lista_pozos.get()) == 0 or len(self.lista_categorias.get()) == 0):
            ...
            self.resultado.title("Resultado de "+pozo+" en la categoria "+categoria)
            ...
            #imagen_fondo=tk.PhotoImage(file="AppData/Images/ecopetrol_bg.gif")
            #fondo_pantalla = tk.Label(self.resultado, image=imagen_fondo)
            #fondo_pantalla.grid(row=0, column=0, sticky=tk.S + tk.N + tk.W + tk.E)
